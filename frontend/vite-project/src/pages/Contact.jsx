  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#dce9e8] via-[#e8f0ef] to-[#d8e2dd]">
      ...
      <div className="mx-3 md:mx-6 mt-4 rounded-[34px] overflow-hidden bg-[#eef4f3]/80 backdrop-blur-xl border border-[#ffffff60] shadow-[0_20px_70px_rgba(0,0,0,0.12)]">
        {/* HERO */}
        <section className="px-4 md:px-12 pt-12 md:pt-20 pb-12 md:pb-16 text-center">
          <motion.p
          ...
          <motion.h1
            ...
            className="mt-5 text-3xl sm:text-4xl md:text-6xl font-serif text-[#315765]"
          >
          ...
          <p className="mt-6 text-[#475569] max-w-2xl mx-auto text-base md:text-lg">
        ...
        <section className="px-6 md:px-12 pb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <motion.div
              ...
              className="rounded-[30px] bg-[#eaf1f0] shadow-xl p-4 md:p-8"
            >
              <h2 className="text-2xl md:text-3xl font-serif text-[#315765]">
                Contact Information
              </h2>

              <p className="mt-4 text-gray-600 leading-relaxed">
                Connect with KashmirCraft team for business inquiries, seller
                onboarding, marketplace support and collaborations.
              </p>

              {/* Info Cards */}
              <div className="mt-8 space-y-5">
                <div className="rounded-2xl bg-white p-4 md:p-5 shadow flex gap-3 md:gap-4 items-start">
              ...
              <div className="mt-10">
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full px-4 md:px-5 py-3 md:py-4 rounded-xl bg-white outline-none border border-gray-200"
                  />
                  ...
                  <textarea
                    ...
                    className="w-full px-4 md:px-5 py-3 md:py-4 rounded-xl  text-gray-600 bg-white outline-none border border-gray-200 resize-none"
                  ></textarea>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
              className="rounded-[30px] overflow-hidden shadow-xl bg-white min-h-[400px]"
            >
              <div className="p-6 border-b">
                ...
                <p className="text-gray-600 mt-2">Kupwara, Jammu & Kashmir</p>
              </div>
